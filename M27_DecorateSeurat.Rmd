...
output.file <- "p4789_allGBM_immuneSubpop_140820.Rdata" # note that run id, module number and user name will automatically be appended as prefix. 
...
# so.query <- so; 
prep.list <- prepSeurat2(so = so, e2s = gNames.list, 
                             species = which.species, resolution= cluster.resolution, subset = which.subset, 

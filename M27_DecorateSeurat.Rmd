...
output.file <- "0_01ds_p4789_allGBM_120820.Rdata" # note that run id, module number and user name will automatically be appended as prefix. 
...
# Data subsampling
subsample_factor <- 0.05 # OPTIONAL; range 0 to 1 (default = 1)
...
o.size <- utils::object.size(so.query)

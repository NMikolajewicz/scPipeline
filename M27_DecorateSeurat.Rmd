...
output.file <- "p4789_allGBM_tumorSubpop_iter1_190820.Rdata" # note that run id, module number and user name will automatically be appended as prefix. 
...
which.subset <- "p4789_tumorImmuneSubpop1_cr0_45"
...
prep.list <- prepSeurat2(so, e2s = gNames.list, 
                             ...
                             subsample = subsample_factor, M00_subgroup.path = "M00_subgroups.csv", terms2drop = which.terms)

...
# , "invitro.GBM", "MCA_50", "Zhang_2019", "Panglao.Hs"  "GBM", "GBM.immune",   "cancerSEA", 
parameter.list <- list(
  input.file = "p13_renca_clean_300521.rds",
  which.references = c("immune.signatures", "immuneSubtype",
                       "cycling.seurat", "immune.Monaco", "MCA_50", "Zhang_2019", "Panglao.Hs",  "cancerSEA", "Kidney_Healthy_Mm"), #"MCA_50", "Zhang_2019", "Panglao.Hs"
...
df.sig2plt.cluster <- unique((vst.merge.cloud %>% 
                                dplyr::group_by(cluster) %>% 
                                dplyr::top_n(parameter.list$show.top.n.gene.panels, composite))[ ,c("cell.type", "ref.set")])
...
For each scoring method, component scores are stratified by cluster and the relationships between gene set size and component score are fitted using loess regression. The residuals are *centered component scores*.\
...
**A**| Dotplot visualizing gene expression across different cell clusters.\

...
packages2load <- c('viridis', 'scMiko', 'ggpubr', 'dplyr', 'ggthemes', 'WGCNA', 'cowplot', 'schex', 'Seurat', 'sctransform', 'plyr', 'tidyr', 'reshape2', 'Matrix', 'RColorBrewer', 'ggplot2', 'gridExtra', 'DT', 'flexdashboard', 'future', 'gplots', 'reticulate')
...
parameter.list <- list(
  ...
  output.object.file = "p16_hs_neuron_merged_310122.Rdata",
...
if (do.dev){
  parameter.list$which.data = c("pilot16.Hs_v2") # c("16-O", "17-O")
  parameter.list$which.strata = "hs_neuron" # NA
...
plt.variable_genes <- variableGenes.Plot(so, gNames.list, set_name = parameter.list$set_names, 
                                         pt.color = c('#2C3E50', '#F39C12'))

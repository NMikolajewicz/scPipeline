...
analysis.parameters <- analysisParameters(
  ...
  save.filename = "p12_Meso_061020.Rdata", # note that prefix containing module number and run ID is appended to save file. 
...
max.memory <- 20 # numeric, in terms of Gb (set to 100 for cluster)
...
try({
  # stopifnot(exists("analysis.parameters$organism.include")) 
   # if (length(analysis.parameters$organism.include) ==  1) 

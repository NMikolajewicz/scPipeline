...
analysis.parameters <- analysisParameters(
  ...
  save.filename = "p12_LungTrouble_061020.Rdata", # note that prefix containing module number and run ID is appended to save file. 
  save.directory = "Preprocessed_Datasets/",
  cluster.resolution = 1,
  gene.upperlimit = Inf, #9000
  gene.lowerlimit = 0,  #200
  mt.upperlimit = 100,   #60

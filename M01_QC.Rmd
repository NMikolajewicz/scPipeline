...
analysis.parameters <- analysisParameters(
  which.data = c("pilot11.Mm"),
  which.strata = c("neural"),
  organism.filter.flag = F,                             
  organism.include = c("Mm"),
  save.flag = T,                                                              # OPTIONAL; logical (default = T)  # save results
  save.filename = "p11_neural_DIV7_270820.Rdata", # note that prefix containing module number and run ID is appended to save file. 

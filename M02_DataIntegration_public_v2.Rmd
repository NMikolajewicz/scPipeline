...
parameter.list <- list(
  save.filename = "p9_14_16_hs_pr_gbm", 
...
# input.data <- list(
#   PijuanSala = list(
#     file = "C:/Users/Owner/Dropbox/PDF Projects - JM/Data/scRNA-seq/01_sci-RNA-seq3_Hong_Kevin_Jason/NM_HH/Data/Preprocessed_Datasets/output_33016PM_demo_ps_10000cell.Rdata",
#     integrate.by = NA,
#     subsample = 0.3,
...
#   # LaManno = list(
#   #   file = "C:/Users/Owner/Dropbox/PDF Projects - JM/Data/scRNA-seq/01_sci-RNA-seq3_Hong_Kevin_Jason/NM_HH/Data/Preprocessed_Datasets/output_33647PM_demo_manno_10000cell.Rdata",
#   #   integrate.by = NA,
#   #   subsample = 0.3,
...
#   # ),
#   Tyser = list(
#     file = "C:/Users/Owner/Dropbox/PDF Projects - JM/R Packages/scMiko/data/so_tyser2021_220621.rds",
#     integrate.by = NA,
#     subsample = 1,
#     meta.feature.name = "Barcode",
#     meta.feature.recode = NA,
...
#   )
#   #   Zeisel = list(
#   #   file = "C:/Users/Owner/Dropbox/PDF Projects - JM/Data/scRNA-seq/01_sci-RNA-seq3_Hong_Kevin_Jason/NM_HH/Data/Preprocessed_Datasets/output_34245PM_demo_zeisel_10000cell.Rdata",
#   #   integrate.by = NA,
#   #   subsample = 0.3,
#   #   meta.feature.name = "Barcode",
#   #   meta.feature.recode = NA,
...
input.data <- list(
  p9 = list(
    file = "R687_M01_NM2_p9_hs_pr_gbm_310122.Rdata",
    integrate.by = "Barcode",
    subsample = 1,
    meta.feature.name = "Barcode",
    meta.feature.filter = NA),
  p14 = list(
    file = "R688_M01_NM2_p14_hs_pr_gbm_310122.Rdata",
    integrate.by = "Barcode",
    subsample = 1,
    meta.feature.name = "Barcode",
    meta.feature.filter = NA),
  p16 = list(
    file = "R685_M01_NM2_p16_hs_pr_gbm_merged_310122.Rdata",
    integrate.by = "Barcode",
    subsample = 1,
    meta.feature.name = "Barcode",
    meta.feature.filter = NA)

...
which.input <- list(
  ...
  which.gene.set =c('mesoderm') # character (e.g., sex.specific)
)
...
if (compute.cor) {
  ...
  if (use.var){
    ...
    # }
    # 
    # exp.mat <- getExpressionMatrix(so.query, only.variable = use.var,
    #                                which.data = which.data, use.additional.genes = available_markers)
    # e.mat <- so.query@assays[["RNA"]]@data

...
parameter.list <- list(
  # General parameters #########################################################
  general.cluster.resolution = 1,    # Numeric [0, Inf]
  general.subsample.factor = 1,      # Numeric (0,1]
  general.subset = data.frame(field = "seurat_clusters", subgroups = c(0:20)),   # 'no.subset' if unspecified
  general.species = "Mm",            # Options: 'Mm', 'Hs'
  general.clean.clusters = F,        # Logical. 
  general.save.pdf = T,              # Logical. 
  ...
  vd.n.workers = 20,                 # Numeric [1,n.available.cores]
